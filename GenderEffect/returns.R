...
model2 <- lm(ret_measure_25~ factor(title_label), data = total_data)


model4<- lm(ret_measure_70~factor(title_label), data = total_data)


model6<- lm(ret_measure_250~factor(title_label), data = total_data)
...
plot(total_data$ret_measure_250, total_data$fut_ret_measure_25) +abline(lm(fut_ret_measure_25 ~ factor(title_label) + ret_measure_250 + factor(title_label)* ret_measure_250, data = total_data))
...
### testing regressions on if women like momentum?

# regression on past returns over a day

model1<- lm(ret_measure_1 ~factor(title_label)+ ret_measure_250 , data = tmp2.no.na)
model2<- lm(ret_measure_1 ~ factor(title_label) + ret_measure_250 , data = tmp3.no.na)
model3<- lm(ret_measure_1 ~ factor(title_label) + ret_measure_250 , data = total_data)
summary(model1)
summary(model2)
summary(model3)
...
model4<- lm(ret_measure_5 ~ factor(title_label) + ret_measure_250 , data = tmp2.no.na)
model5<- lm(ret_measure_5 ~ factor(title_label) + ret_measure_250, data = tmp3.no.na)
model6<- lm(ret_measure_5 ~ factor(title_label) + ret_measure_250 , data = total_data)
summary(model4)
summary(model5)
summary(model6)
...
model7<- lm(ret_measure_25 ~ factor(title_label) + ret_measure_250 , data = total_data)
model8<- lm(ret_measure_25 ~ factor(title_label) + ret_measure_250 , data = tmp3.no.na)
model9<- lm(ret_measure_25 ~ factor(title_label) + ret_measure_250 , data = total_data)
summary(model7)
summary(model8)
summary(model9)
#regression on past retunrs over a 70 day period

model10<- lm(fut_ret_measure_70~ factor(title_label) + ret_measure_250 , data = tmp2.no.na)
model11<- lm(fut_ret_measure_70 ~ factor(title_label) + ret_measure_250, data = tmp3.no.na)
model12<- lm(fut_ret_measure_70 ~ factor(title_label) + ret_measure_250 , data = total_data)
summary(model10)
summary(model11)
summary(model12)
...
model2 <- lm(ret_measure_25~ factor(title_label), data = total_data3)


model4<- lm(ret_measure_70~factor(title_label), data = total_data3)


model6<- lm(ret_measure_250~factor(title_label), data = total_data3)
...
model9<- glm(fut_ret_measure_25 ~ factor(title_label) + x+ factor(title_label)*x, data = dataSet)
summary(model9)


model9<- glm(fut_ret_measure_25~ factor(title_label) + z+ factor(title_label)* z, data = dataSet)
summary(model9)
