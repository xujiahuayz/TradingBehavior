...
\title[Short title]{Learning (not) to trade: Lindy's law in retail traders} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Teodor Godina \and Serge Kassibrakis \and Semyon Malamud \and Alberto Teguia \and Jiahua (Java) Xu} % Your name
\institute[EPFL]
{
	Teodor Godina \and Serge Kassibrakis \and Semyon Malamud \and Alberto Teguia \and Jiahua (Java) Xu
%Swissquote, EPFL, SFI, UBC, UCL \\ % Your institution for the title page
\medskip
}
...
\begin{frame}{Exit procrastination---Lindy's law?}
	...
	\begin{figure}
	\includegraphics[height=0.231\linewidth,trim={10 30 18 0},clip]{figures/exitTS-1}
	\includegraphics[height=0.231\linewidth,trim={49 30 18 0},clip]{figures/exitTS-2}
	\includegraphics[height=0.231\linewidth,trim={49 30 18 0},clip]{figures/exitTS-3}
	\caption{At any given return level (left to right: lowest to highest tertile), higher trading age is associated with lower exit rate}
	\end{figure}
...
\begin{frame}{Literature review}
	...
	\begin{itemize}
		...
		\item \cite{Schraeder2016}: young investors trade frequently but obtain lower returns.
...
\begin{frame}{Belief lower boundary $\ell_*(t, \varphi)$}
	...
	$\ell_*(t, \varphi)$ decreases with $t$
%	---but does that translate into exit procrastination?
\end{frame}
